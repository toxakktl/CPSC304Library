...
insert into borrower values (bid_counter.nextval, 'kevin123123','Kevin Ye','1234 Kevin St. Richmond B.C. Canada',7781234567,'kevin@kevin.com','47618103',sysdate,'Student');

insert into borrower values (bid_counter.nextval, 'paulo123123','Paulo Apolinar','1234 Paulo St. White Rock B.C. Canada',7782345678,'paulo@paulo.com','41218103',sysdate,'Student');

insert into borrower values (bid_counter.nextval, 'tokhtar123', 'Tokhtar Yelemessov','1234 Tokhtar St. Coquitlum B.C. Canada',7782345678,'tokhtar@tokhtar.com','41213203',sysdate,'Staff');
...
insert into hassubject values ('PL2848.Y8 S54','Novel');
...
insert into bookcopy values ('DS778.M3 T87','C1','on-hold');


/* HoldRequest */

insert into holdrequest values (hid_counter.nextval, 1001, 'PL2848.Y8 S54', sysdate-2);

insert into holdrequest values (hid_counter.nextval, 1002, 'PL2960.U826 C36', sysdate-1);

insert into holdrequest values (hid_counter.nextval, 1003, 'DS778.M3 T87', sysdate);
...
insert into borrowing values (borid_counter.nextval, 1002,'PL2960.U826 C36','C1',sysdate,sysdate + 14);

insert into borrowing values (borid_counter.nextval, 1003,'DS778.M3 T87','C1',sysdate,sysdate + 120);
...
insert into fine values (fineid_counter.nextval, 3.06, sysdate-4, sysdate, 1002);

insert into fine values (fineid_counter.nextval, 1.11, sysdate-2, sysdate, 1003);
